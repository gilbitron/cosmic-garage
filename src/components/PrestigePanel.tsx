      ...
      <div className="bg-gray-700 rounded-lg p-6 text-center">
        ...
        <div className="mb-6 space-y-2">
          <div className="text-sm">
            ...
            <span className="text-yellow-400 ml-2">{formatNumber(totalCreditsEarned)}</span>
          </div>
          <div className="text-sm">
            <span className="text-gray-400">Prestige Count:</span>
            <span className="text-purple-400 ml-2">{prestigeCount}</span>
          </div>
        </div>
        ...
        <div className="mb-6 p-4 bg-gray-600 rounded-lg">
          ...
          <p className="text-sm text-gray-400">
            Reset your garage to gain reputation for permanent upgrades
          </p>
        </div>

        <button
          onClick={() => {
            if (window.confirm(`Are you sure you want to prestige? You will gain ${prestigeGain} reputation.`)) {
              prestige();
            }
          }}
        ...
        >
          {canPrestige 
            ? `PRESTIGE - Gain ${prestigeGain} Reputation` 
            : 'Need more credits to prestige'}
        </button>

        <div className="mt-6 text-sm text-gray-400">
          <p className="mb-2">Prestige unlocks at <span className="text-yellow-400">1,000 credits</span></p>
