    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-gray-800 border-t border-gray-700 p-2">
        <div className="max-w-3xl mx-auto text-center text-xs text-gray-500 space-y-1">
          <div>Auto-saves every 30 seconds • <a href="https://github.com/gilbitron/cosmic-garage" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">Cosmic Garage v1.0</a></div>
